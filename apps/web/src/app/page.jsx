...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="max-w-[1100px] mx-auto px-4 md:px-5 pt-16 pb-12 md:pt-28 md:pb-20">
        <div className="max-w-[520px]">
          <div className="text-[11px] font-medium text-gray-400 tracking-wider mb-3 md:mb-4">AI 기반 소상공인 경영 비서</div>
          <h1 className="text-[32px] md:text-[48px] font-extrabold text-gray-900 leading-[1.1] tracking-tight mb-4 md:mb-5">
            사장님의<br />성공 이유, W-AI
          </h1>
          <p className="text-gray-500 text-[13px] md:text-[14px] leading-relaxed mb-6 md:mb-8 max-w-[380px]">
      ...
      <section id="demo" className="border-y border-gray-100 bg-gray-50/50">
        <div className="max-w-[1100px] mx-auto px-4 md:px-5 py-10 md:py-16">
      ...
      {/* Features */}
      <section id="features" className="max-w-[1100px] mx-auto px-4 md:px-5 py-10 md:py-16">
      ...
      <section className="border-t border-gray-100">
        <div className="max-w-[1100px] mx-auto px-4 md:px-5 py-10 md:py-16 text-center">
