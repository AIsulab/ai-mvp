...
export default function StoreInfoForm({ storeInfo, setStoreInfo, onAnalyze, isAnalyzing }) {
  return (
    <div
      className="bg-white dark:bg-gray-800 rounded-xl p-5 md:p-6 mb-4 animate-slide-up"
      style={{ boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}
    >
      <div className="flex items-center gap-2 mb-4">
        <h2 className="text-[15px] font-semibold text-[#111827] dark:text-white">내 가게 정보</h2>
        <span className="text-xs text-gray-400 dark:text-gray-500">(한 번만 입력하세요)</span>
      </div>
