...
export default function HeroSection({ weather, weatherLoading, region }) {
  return (
    <div className="bg-gradient-to-br from-primary-500 via-primary-600 to-primary-700 text-white animate-fade-in">
      <div className="px-5 md:px-8 py-8 md:py-12">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="flex-1">
            <div className="inline-flex items-center gap-1.5 bg-white/15 text-white/90 px-3 py-1 rounded-full text-xs font-medium mb-4 backdrop-blur-sm">
            ...
            <p className="text-white/70 text-sm md:text-base mb-6 max-w-lg leading-relaxed">
          ...
          {/* Weather Card */}
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-5 md:p-6 w-full md:w-56 text-center">
            {weatherLoading ? (
