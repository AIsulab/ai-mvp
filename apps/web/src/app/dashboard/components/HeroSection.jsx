      ...
      <div className="px-5 md:px-6 py-6 md:py-8">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-5">
          <div className="flex-1">
            <div className="text-[12px] font-medium text-gray-400 tracking-wider mb-2">WEATHER AI</div>
            <h1 className="text-[24px] md:text-[28px] font-bold mb-2 tracking-tight">
              오늘 날씨에 맞는 마케팅 문구
            </h1>
            <p className="text-gray-400 text-[15px] mb-4 max-w-md">
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-5 w-full md:w-52">
            {weatherLoading ? (
              ...
              <>
                ...
                <div className="text-[14px] text-gray-400 mb-3">{weather?.condition || "로딩 중..."}</div>
                <div className="inline-flex items-center gap-1 bg-white/10 text-white/80 py-1.5 px-2.5 rounded-full text-[12px] font-medium">
