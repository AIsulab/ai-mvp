  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-card p-5 flex-1">
      ...
      <div className="flex justify-end mb-4 mt-3">
        <Button variant="primary" size="sm" onClick={onGenerate} disabled={isReplying || !reviewInput} loading={isReplying}>
          AI 답변 생성
        </Button>
      </div>
      <div>
        <label className="text-[11px] text-gray-500 mb-1.5 block font-medium">AI 답변</label>
        <div className="w-full min-h-[80px] bg-primary-50 border border-primary-100 rounded-xl p-3 text-sm text-gray-700 whitespace-pre-wrap">
