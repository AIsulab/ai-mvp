  ...
  return (
    <div className="max-w-3xl mx-auto animate-fade-in">
      ...
      <Card className="mb-5">
        ...
        <Button variant="primary" className="w-full mt-5" onClick={generate} disabled={isGenerating || !businessType || !event} loading={isGenerating}>
        ...
        <Card>
          <div className="flex items-center justify-between mb-4">
            ...
            <Button variant="ghost" size="sm" onClick={() => copy(result, "main")}>
              {copied === "main" ? <><Check size={11} className="text-green-500" /> 복사됨</> : <><Copy size={11} /> 전체 복사</>}
            </Button>
          </div>
