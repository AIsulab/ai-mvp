...
const allFunds = [
  { id: 1, name: "2026년 소상공인 경영안정 바우처", org: "소상공인시장진흥공단", amount: "연 최대 25만원", rate: "무상 지원", deadline: "2026.11.30", desc: "전기·가스·수도요금, 4대 보험료 등 고정비 부담 완화를 위한 바우처 지급", category: "바우처", types: ["카페","식당/한식","치킨/배달","베이커리","편의점","미용실","옷가게","기타"], tags: ["매출 1.04억 미만", "전국"], status: "신청중" },
  { id: 2, name: "소상공인 대환대출 및 일반경영안정자금", org: "중소벤처기업부", amount: "최대 7,000만원", rate: "변동 금리", deadline: "예산 소진 시", desc: "고금리 대출 이자 부담 완화 및 사업 운영 자금 융자 지원", category: "융자", types: ["카페","식당/한식","치킨/배달","베이커리","편의점","미용실","옷가게","기타"], tags: ["저신용자 가능", "상시 신청"], status: "상시" },
  { id: 3, name: "스마트상점 기술보급사업 (디지털 전환)", org: "소상공인시장진흥공단", amount: "최대 500만원", rate: "국비 70% 지원", deadline: "2026.08.30", desc: "AI, 키오스크, 서빙로봇 등 스마트기술 도입 비용 지원", category: "보조금", types: ["카페","식당/한식","치킨/배달","베이커리"], tags: ["디지털 전환", "선착순"], status: "마감임박" },
  { id: 4, name: "2026 강한 소상공인 성장지원", org: "소상공인시장진흥공단", amount: "최대 1억원", rate: "무상 지원", deadline: "2026.09.15", desc: "유망 소상공인의 스케일업 및 혁신 제품 발굴 지원", category: "보조금", types: ["카페","식당/한식","베이커리","옷가게","기타"], tags: ["사업화 자금", "경쟁형"], status: "예정" },
  { id: 5, name: "전북특별자치도 소상공인 특례보증", org: "전북신용보증재단", amount: "최대 3,000만원", rate: "연 2.0% 이자지원", deadline: "2026.10.31", desc: "전북 소재 소상공인의 경영 안정을 위한 저금리 특례보증 및 이자 지원", category: "지역 지원", types: ["카페","식당/한식","치킨/배달","베이커리","편의점","미용실","옷가게","기타"], tags: ["전북 소재", "이자 보전"], status: "신청중" },
  { id: 6, name: "희망리턴패키지 (재기 지원)", org: "소상공인시장진흥공단", amount: "최대 600만원", rate: "무상 지원", deadline: "상시 운영", desc: "경영위기 소상공인 대상 점포 철거비 지원 및 재창업 사업화 자금 지원", category: "재기지원", types: ["카페","식당/한식","치킨/배달","베이커리","편의점","미용실","옷가게","기타"], tags: ["폐업 예정자", "재창업"], status: "상시" },
];
